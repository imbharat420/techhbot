let a = {
    ...
    voices: [{
        ...
        "StyleList": ["assistant", "chat", "customerservice", "newscast", "angry", "cheerful", "sad", "excited", "friendly", "terrified", "shouting", "unfriendly", "whispering", "hopeful"],
        "SampleRateHertz": "48000",
        "VoiceType": "Neural",
        "Status": "GA",
        "WordsPerMinute": "152"
        ...
        "Locale": "en-US",
        "LocaleName": "English (United States)",
        "SecondaryLocaleList": ["de-DE", "en-AU", "en-CA", "en-GB", "es-ES", "es-MX", "fr-CA", "fr-FR", "it-IT", "ja-JP", "ko-KR", "pt-BR", "zh-CN"],
        "SampleRateHertz": "48000",
        "VoiceType": "Neural",
        "Status": "GA",
        "WordsPerMinute": "190"
        ...
        "Locale": "en-US",
        "LocaleName": "English (United States)",
        "StyleList": ["chat", "customerservice", "narration-professional", "newscast-casual", "newscast-formal", "cheerful", "empathetic", "angry", "sad", "excited", "friendly", "terrified", "shouting", "unfriendly", "whispering", "hopeful"],
        "SampleRateHertz": "48000",
        "VoiceType": "Neural",
        "Status": "GA",
        "WordsPerMinute": "150"
        ...
        "StyleList": ["assistant", "chat", "customerservice", "newscast", "affectionate", "angry", "calm", "cheerful", "disgruntled", "fearful", "gentle", "lyrical", "sad", "serious", "poetry-reading"],
        "SampleRateHertz": "48000",
        "VoiceType": "Neural",
        "Status": "GA",
        "WordsPerMinute": "274"
        ...
        "Locale": "zh-CN",
        "LocaleName": "Chinese (Mandarin, Simplified)",
        "StyleList": ["embarrassed", "calm", "fearful", "cheerful", "disgruntled", "serious", "angry", "sad", "depressed", "affectionate", "gentle", "envious"],
        "SampleRateHertz": "48000",
        "VoiceType": "Neural",
        "Status": "GA",
        ...
        "Locale": "zh-CN",
        "LocaleName": "Chinese (Mandarin, Simplified)",
        "StyleList": ["narration-relaxed", "embarrassed", "fearful", "cheerful", "disgruntled", "serious", "angry", "sad", "depressed", "chat", "assistant", "newscast"],
        "SampleRateHertz": "48000",
        "VoiceType": "Neural",
        "Status": "GA",
        ...
        "Locale": "zh-CN",
        "LocaleName": "Chinese (Mandarin, Simplified)",
        "StyleList": ["narration-relaxed", "sports-commentary", "sports-commentary-excited"],
        "SampleRateHertz": "48000",
        "VoiceType": "Neural",
        "Status": "Preview",
        "WordsPerMinute": "279"
    ...
    loadMore: false,
    supportedLanguage: [
        'af-', 'ar-', 'bn-', '', 'ca-', 'zh-', 'en-', 'fil-', 'fr-', 'de-', 'gu-', 'he-', 'hi-', 'id-', 'it-',
        'ja-', 'ko-', 'ms-', 'nb-', 'pt-', 'ru-', 'es-', 'sv-', 'ta-', 'te-', 'tr-', 'ur-'
    ],
    loading: false,
    showNewUpgradeSection: false,
    data: {
        Locale: 'en-US',
        ShortName: 'en-US-JennyNeural',
        Text: ''
    ...
    styleAudios: {
        ...
        'chinese_mandarin': [{
                title: "Xiaohen",
                file: "chinese/Xiaohen.mp3"
            },
            {
                title: "Xiaomo",
                file: "chinese/Xiaomo.mp3"
            },
            {
                title: "Xiaorui",
                file: "chinese/Xiaorui.mp3"
            },
            {
                title: "Xiaoxiao",
                file: "chinese/Xiaoxiao.mp3"
            },
            {
                title: "Xiaoxuan",
                file: "chinese/Xiaoxuan.mp3"
            },
            {
                title: "Yunjian",
                file: "chinese/Yunjian.mp3"
            },
            {
                title: "Yunxi",
                file: "chinese/Yunxi.mp3"
            },
            {
                title: "Yunyang",
                file: "chinese/Yunyang.mp3"
            },
            {
                title: "Yunye",
                file: "chinese/Yunye.mp3"
            },
        ],
        'french_france': [{
            title: "Alice",
            file: "Alice-french.mp3"
        }, ],
        'japanese': [{
            title: "Nanami",
            file: "Nanami-Japan.mp3"
        }, ],
        'portuguese_brazil': [{
            title: "Francisca",
            file: "Francisca-Portuguese-Brazil.mp3"
        }, ]
    }
}
